...
public class DateInPastValidator implements ConstraintValidator<DateInPast, String> {

    @Override
    public void initialize(DateInPast annotation) {
    ...
    public boolean isValid(String dateStr, ConstraintValidatorContext context) {
        ...
        if ( dateStr != null ) {
            Date date = ValidationUtil.parseIncompleteDate( dateStr );
            if ( date != null ) {
                valid = date.before( new Date() );
            }
        }
        return valid;
    }
